<template>
  <div>
    <FeatherSelect :label="labelForSelect" :options="months" class="month">
    </FeatherSelect>

    <h1>D3 Chart</h1>
    <h3>Using Entire d3 library</h3>
    <p>
      Need to import only the specific d3 libraries necessary to render the
      chart
    </p>
    <FeatherChartD3
      id="chart1"
...
import {
  FeatherChartD3Dimensions,
  FeatherChartData,
  FeatherChartD3Options,
  FeatherChartAxes,
...
// Data
const personData: FeatherChartData = [
...
const serverData: FeatherChartData = [
...
// Default dimensions
const dimensions: FeatherChartD3Dimensions = {
  height: 250,
  width: 500,
...
// Chart 1
const chartOptions1: FeatherChartD3Options = {
  class: "color1",
  units: "years of experience",
};

const chartAxes1: FeatherChartAxes = {
  x: "person",
  y: "project.experience",
};

// Chart 1b
const chartOptions1b: FeatherChartD3Options = { ...chartOptions1 };
chartOptions1b.class = "color2";
chartOptions1b.units = "hours worked";

const chartAxes1b: FeatherChartAxes = {
  x: "person",
  y: "project.hours",
};
...
// Chart 2
let chartOptions2: FeatherChartD3Options = { ...chartOptions1 };
chartOptions2.class = "color1";
chartOptions2.units = "unknown server errors";

const chartAxes2: FeatherChartAxes = {
  x: "svr.tx",
  y: "svr.evt.500",
};
...
// Chart 2b
let chartOptions2b: FeatherChartD3Options = { ...chartOptions1 };
chartOptions2b.class = "color2";
chartOptions2b.units = "successful transactions";

const chartAxes2b: FeatherChartAxes = {
  x: "svr.tx",
  y: "svr.evt.200",
};
