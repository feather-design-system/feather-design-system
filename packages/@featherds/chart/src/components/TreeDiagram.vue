...
.feather-tree-diagram-svg {
  ...
  g.node-group.container-type {
    ...
    .badge {
      ...
      &.error {
        fill: utils.alpha(vars.$error, 0.12);
        stroke: var(vars.$error);
      }
  ...
  g.node-group {
    ...
    &:hover {
      background-color: var(vars.$shade-3);
      cursor: pointer;
      .fo {
        .node-fo-container {
    ...
    &.selected {
      ...
      .node {
        fill: utils.alpha(vars.$primary, 0.2);
        filter: drop-shadow(4px 2px 2px var(--feather-shade-3));
      }
      .fo {
        .text-container {
          background-color: utils.alpha(vars.$primary, 0.1);
        }
        .node-fo-container {
          .node-fo-text {
      ...
      .icon-background {
        fill: utils.alpha(vars.$primary, 0.05);
      }
    }
